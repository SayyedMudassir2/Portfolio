...
const Project = ({
  ...
  const handleMouseMove: MouseEventHandler<HTMLDivElement> = (e) => {
    ...
    const xPos = (e.clientX - clientReact.left) / clientReact.width - 0.5;
    const yPos = (e.clientY - clientReact.top) / clientReact.height - 0.5;
  ...
  return (
    <Reveal initialX={-50} delay={0.5}>
      <motion.div
        ...
        className="card flex flex-col items-stretch w-full max-w-[428px] p-5 md:p-[18px] gap-[30px]"
        style={{
